...
Shows the size of each directory below user specified directory or current working directory if none is specified.
...
```text
Duble shows the size of each directory below user specified directory or current working directory if none is specified.
...
For Duble project updates and bug reports, visit https://github.com/Soulsbane/dubleDuble shows the size of each directory below user specified directory or current working directory if none specified.
Usage: duble [--root-only] [--list-all] [--sort-by SORT-BY] [--sort-order SORT-ORDER] [DIRNAME]
